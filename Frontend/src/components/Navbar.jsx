    ...
    <>
      <div
        className={`max-w-screen 2xl mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50
              ${
                sticky
                  ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transtion-all ease-in-out"
                  : " "
              }
                  `}
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer">USTAD G</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <a
              className=" bg-black text-white  px-3 py-2 rounded-xl hover:bg-slate-700 duration-200 cursor-pointer"
